xThis repository contains source code for the framework of this work; these classes are used to learn contextual vectors and sentence vectors, and to choose sentences to be used in the explanations.  
